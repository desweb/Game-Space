function User()
{
	...
	function _login(datas)
	{
		...
		_access_token_expired_time	= parseInt(datas.user_token.expired_at);

		_reference		= datas.reference;
		_username		= datas.username;
		_email			= datas.email;
		_birthday_time	= parseInt(datas.birthday_at);
	...
	function _displayProfil()
	{
		...
		var d = (birthday_at.getDate() < 10? '0': '') + birthday_at.getDate();
